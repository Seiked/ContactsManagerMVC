...
namespace ContactsManager.Infrastructure.Migrations
{
    ...
    [Migration("20250702034106_Initialize")]
            ...
            modelBuilder.Entity("Entities.Person", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Address = "Calle Insurgentes Sur 345, CDMX",
                            CountryID = new Guid("12e15727-d369-49a9-8b13-bc22e9362179"),
                            DateOfBirth = new DateTime(1987, 1, 9, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "andres.silva@correo.com.mx",
                            Gender = "Male",
                            PersonName = "Andrés",
                            ReceiveNewsLetters = true
                        },
                        new
                        {
                            ...
                            Address = "Calle San Martín 1212, Rosario",
                            CountryID = new Guid("56bf46a4-02b8-4693-a0f5-0a95e2218bdc"),
                            DateOfBirth = new DateTime(1995, 2, 11, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "tatiana.ruiz@correo.com.ar",
                            Gender = "Gender",
                            PersonName = "Tatiana",
                            ReceiveNewsLetters = false
                        },
                        new
                        {
                            ...
                            Email = "miguel.luna@correo.com.br",
                            Gender = "Male",
                            PersonName = "Miguel",
                            ReceiveNewsLetters = false
                        },
                        ...
                        new
                        {
                            ...
                            Address = "Calle Juárez 432, Guadalajara",
                            CountryID = new Guid("12e15727-d369-49a9-8b13-bc22e9362179"),
                            DateOfBirth = new DateTime(1998, 12, 2, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "valentina.mendez@correo.com.mx",
                            Gender = "Female",
                        ...
                        new
                        {
                            ...
                            Address = "Av. Atlântica 2222, Rio de Janeiro",
                            CountryID = new Guid("8f30bedc-47dd-4286-8950-73d8a68e5d41"),
                            DateOfBirth = new DateTime(1997, 9, 25, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "esteban.oliveira@correo.com.br",
                            Gender = "Male",
                            PersonName = "Esteban",
                            ReceiveNewsLetters = false
                        },
                        new
                        {
                            ...
                            Address = "Calle Durazno 450, Montevideo",
                            CountryID = new Guid("501c6d33-1bbe-45f1-8fbd-2275913c6218"),
                            DateOfBirth = new DateTime(1990, 5, 24, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "monica.alvarez@correo.com.uy",
                            Gender = "Female",
                            PersonName = "Mónica",
                            ReceiveNewsLetters = true
                        },
                        new
                        {
                            ...
                            Address = "Av. Italia 1233, Montevideo",
                            CountryID = new Guid("501c6d33-1bbe-45f1-8fbd-2275913c6218"),
                            DateOfBirth = new DateTime(1987, 1, 19, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "veronica.gonzalez@correo.com.uy",
                            Gender = "Female",
                            PersonName = "Verónica",
                            ReceiveNewsLetters = true
                        });
